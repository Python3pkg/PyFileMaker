...
class FMServer:
    ...
    def _setComparasionOperator(self, field, oper):
        ...
        if not string.lower(oper) in list(validOperators.keys()):
    ...
    def _addSortParam(self, field, order=''):
        ...
        if order != '':
            ...
            if not string.lower(order) in list(validSortOrders.keys()):
    ...
    def _preFind(self, WHAT={}, SORT=[], SKIP=None, MAX=None, LOP='AND'):
        ...
        if hasattr(WHAT, '_modified'):
            ...
            raise FMError(
                'Python Runtime: Object type (%s) given to on of function doFind* as argument WHAT cannot be used.' % type(
                    WHAT))
    ...
    def doDelete(self, WHAT={}):
        ...
        elif type(WHAT) == dict and 'RECORDID' in WHAT:
            self._addDBParam('RECORDID', WHAT['RECORDID'])
        else:
            raise FMError(
                'Python Runtime: Object type (%s) given to function doDelete as argument WHAT cannot be used.' % type(
                    WHAT))
    ...
    def doEdit(self, WHAT={}, **params):
        ...
        if hasattr(WHAT, '_modified'):
            ...
            raise FMError(
                'Python Runtime: Object type (%s) given to function doEdit as argument WHAT cannot be used.' % type(
                    WHAT))
    ...
    def doNew(self, WHAT={}, **params):
        ...
        if hasattr(WHAT, '_modified'):
            ...
            raise FMError(
                'Python Runtime: Object type (%s) given to function doNew as argument WHAT cannot be used.' % type(
                    WHAT))
    ...
    def doDup(self, WHAT={}, **params):
        ...
        if hasattr(WHAT, '_modified'):
            ...
            raise FMError(
                'Python Runtime: Object type (%s) given to function doDup as argument WHAT cannot be used.' % type(
                    WHAT))
